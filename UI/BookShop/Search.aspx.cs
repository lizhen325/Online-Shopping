...
namespace UI.BookShop
{
    public partial class Search : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int rowsCount = bll.GetRecordCount(" Title like '%"+search+"%'");
            RowsCount = rowsCount;
            if(rowsCount == 0)
            {
                Notice = "<p style=color:red>There is no Item.</p>";
            }
            ...
            DataTable dt = bll.GetListByPage("Title like '%" + search + "%'", "", (pageIndex - 1) * pageSize + 1, pageIndex * pageSize).Tables[0];
