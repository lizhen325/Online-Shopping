<%@ Page Title="" Language="C#" MasterPageFile="~/BookShop/Shop.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="UI.BookShop.Search" %>
    ...
    <div class="container" style=" text-align: center;">
        ...
        <div class="row" style="margin:0  auto;">
            <div class="col-md-4 col-lg-4">
                <a href="<%="/"+item.Id/5000+"/"+item.Id+".html" %>" class="thumbnail">
                    <p><%=item.BookTitle %></p>
                    <p><%=item.SubTitle %></p>
